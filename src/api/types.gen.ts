...
export type ClientOptions = {
  baseUrl:
    | "https://api.smotra.net/v1"
    | "https://staging-api.smotra.net/v1"
...
export type TracerouteCheckType =
  (typeof TracerouteCheckType)[keyof typeof TracerouteCheckType];

export const TcpConnectCheckType = { TCPCONNECT: "tcpconnect" } as const;

export type TcpConnectCheckType =
  (typeof TcpConnectCheckType)[keyof typeof TcpConnectCheckType];

export const UdpConnectCheckType = { UDPCONNECT: "udpconnect" } as const;

export type UdpConnectCheckType =
  (typeof UdpConnectCheckType)[keyof typeof UdpConnectCheckType];

export const HttpGetCheckType = { HTTPGET: "httpget" } as const;

export type HttpGetCheckType =
  (typeof HttpGetCheckType)[keyof typeof HttpGetCheckType];

export const PluginCheckType = { PLUGIN: "plugin" } as const;

export type PluginCheckType =
  (typeof PluginCheckType)[keyof typeof PluginCheckType];
...
export type AgentHealthStatus =
  (typeof AgentHealthStatus)[keyof typeof AgentHealthStatus];
 ...
 */
export const ClaimStatusPendingEnum = {
 ...
 * Pending claim status
 */
export type ClaimStatusPendingEnum =
  (typeof ClaimStatusPendingEnum)[keyof typeof ClaimStatusPendingEnum];
 ...
 * Claimed status
 */
export type ClaimStatusClaimedEnum =
  (typeof ClaimStatusClaimedEnum)[keyof typeof ClaimStatusClaimedEnum];
 ...
 * Report acknowledgment status
 */
export type ReportAckStatus =
  (typeof ReportAckStatus)[keyof typeof ReportAckStatus];
 ...
 * Metric status
 */
export type AggregatedMetricStatus =
  (typeof AggregatedMetricStatus)[keyof typeof AggregatedMetricStatus];
...
export type UpdateUserStatus =
  (typeof UpdateUserStatus)[keyof typeof UpdateUserStatus];
...
export type SubmitAgentStatusError =
  SubmitAgentStatusErrors[keyof SubmitAgentStatusErrors];
...
export type SubmitAgentStatusResponse =
  SubmitAgentStatusResponses[keyof SubmitAgentStatusResponses];
...
export type RegisterAgentSelfError =
  RegisterAgentSelfErrors[keyof RegisterAgentSelfErrors];
...
export type RegisterAgentSelfResponse =
  RegisterAgentSelfResponses[keyof RegisterAgentSelfResponses];
...
export type GetAgentClaimStatusError =
  GetAgentClaimStatusErrors[keyof GetAgentClaimStatusErrors];
...
export type GetAgentClaimStatusResponse =
  GetAgentClaimStatusResponses[keyof GetAgentClaimStatusResponses];
...
export type PostClaimAgentError =
  PostClaimAgentErrors[keyof PostClaimAgentErrors];
...
export type PostClaimAgentResponse =
  PostClaimAgentResponses[keyof PostClaimAgentResponses];
...
export type GetAgentConfigurationError =
  GetAgentConfigurationErrors[keyof GetAgentConfigurationErrors];
...
export type GetAgentConfigurationResponse =
  GetAgentConfigurationResponses[keyof GetAgentConfigurationResponses];
...
export type UpdateAgentConfigurationError =
  UpdateAgentConfigurationErrors[keyof UpdateAgentConfigurationErrors];
...
export type UpdateAgentConfigurationResponse =
  UpdateAgentConfigurationResponses[keyof UpdateAgentConfigurationResponses];
...
export type SendAgentHeartbeatError =
  SendAgentHeartbeatErrors[keyof SendAgentHeartbeatErrors];
...
export type SendAgentHeartbeatResponse =
  SendAgentHeartbeatResponses[keyof SendAgentHeartbeatResponses];
...
export type SubmitAgentResultsError =
  SubmitAgentResultsErrors[keyof SubmitAgentResultsErrors];
...
export type SubmitAgentResultsResponse =
  SubmitAgentResultsResponses[keyof SubmitAgentResultsResponses];
...
export type GetResultReportError =
  GetResultReportErrors[keyof GetResultReportErrors];
...
export type GetResultReportResponse =
  GetResultReportResponses[keyof GetResultReportResponses];
...
export type DeleteAlertResponse =
  DeleteAlertResponses[keyof DeleteAlertResponses];
...
export type AcknowledgeAlertError =
  AcknowledgeAlertErrors[keyof AcknowledgeAlertErrors];
...
export type AcknowledgeAlertResponse =
  AcknowledgeAlertResponses[keyof AcknowledgeAlertResponses];
...
export type Oauth2TokenResponse =
  Oauth2TokenResponses[keyof Oauth2TokenResponses];
...
export type PostCreateUserError =
  PostCreateUserErrors[keyof PostCreateUserErrors];
...
export type PostCreateUserResponse =
  PostCreateUserResponses[keyof PostCreateUserResponses];
...
export type PostCreateOrganizationResponse =
  PostCreateOrganizationResponses[keyof PostCreateOrganizationResponses];
...
export type GetWebSocketTokenData = {
  body: {
     ...
     */
    subscriptions: Array<
      "alerts" | "metrics" | "agent_status" | "system_events"
    >;
    /**
...
export type GetWebSocketTokenError =
  GetWebSocketTokenErrors[keyof GetWebSocketTokenErrors];
...
export type GetWebSocketTokenResponse =
  GetWebSocketTokenResponses[keyof GetWebSocketTokenResponses];
...
export type PrometheusMetricsResponse =
  PrometheusMetricsResponses[keyof PrometheusMetricsResponses];
