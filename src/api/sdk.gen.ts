...
import {
  ...
  getOrganizationResponseTransformer,
  getResultReportResponseTransformer,
  ...
  registerAgentSelfResponseTransformer,
  submitAgentResultsResponseTransformer,
  submitAgentStatusResponseTransformer,
  updateAgentConfigurationResponseTransformer,
  updateUserRolesResponseTransformer,
...
import type {
  ...
  DeleteAlertData,
  DeleteAlertErrors,
  DeleteAlertResponses,
  DeleteUserData,
  DeleteUserErrors,
  DeleteUserResponses,
  GetAgentClaimStatusData,
  GetAgentClaimStatusErrors,
  GetAgentClaimStatusResponses,
  GetAgentConfigurationData,
  GetAgentConfigurationErrors,
  GetAgentConfigurationResponses,
  GetAlertData,
  GetAlertErrors,
  GetAlertResponses,
  GetMetricsData,
  ...
  GetResultReportData,
  GetResultReportErrors,
  GetResultReportResponses,
  GetSummaryData,
  GetSummaryResponses,
  GetUserData,
  GetUserErrors,
  ...
  GetUserResponses,
  GetWebSocketTokenData,
  GetWebSocketTokenErrors,
  GetWebSocketTokenResponses,
  HealthCheckData,
  HealthCheckErrors,
  ...
  PatchUserResponses,
  PostClaimAgentData,
  PostClaimAgentErrors,
  PostClaimAgentResponses,
  PostCreateOrganizationData,
  PostCreateOrganizationResponses,
  PostCreateUserData,
  PostCreateUserErrors,
  PostCreateUserResponses,
  PrometheusMetricsData,
  PrometheusMetricsResponses,
  ReadinessCheckData,
  ReadinessCheckErrors,
  ReadinessCheckResponses,
  RegisterAgentSelfData,
  RegisterAgentSelfErrors,
  RegisterAgentSelfResponses,
  SendAgentHeartbeatData,
  SendAgentHeartbeatErrors,
  SendAgentHeartbeatResponses,
  SubmitAgentResultsData,
  SubmitAgentResultsErrors,
  SubmitAgentResultsResponses,
  SubmitAgentStatusData,
  SubmitAgentStatusErrors,
 ...
 *
 */
export const submitAgentStatus = <ThrowOnError extends boolean = false>(
  options: Options<SubmitAgentStatusData, ThrowOnError>,
) =>
 ...
 *
 */
export const registerAgentSelf = <ThrowOnError extends boolean = false>(
  options: Options<RegisterAgentSelfData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    RegisterAgentSelfResponses,
    RegisterAgentSelfErrors,
 ...
 *
 */
export const getAgentClaimStatus = <ThrowOnError extends boolean = false>(
  options: Options<GetAgentClaimStatusData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetAgentClaimStatusResponses,
    GetAgentClaimStatusErrors,
    ThrowOnError
  >({ url: "/agent/{agentId}/claim-status", ...options });
 ...
 *
 */
export const postClaimAgent = <ThrowOnError extends boolean = false>(
  options: Options<PostClaimAgentData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    PostClaimAgentResponses,
    PostClaimAgentErrors,
 ...
 */
export const getAgentConfiguration = <ThrowOnError extends boolean = false>(
  options: Options<GetAgentConfigurationData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetAgentConfigurationResponses,
    GetAgentConfigurationErrors,
  ...
  >({
    ...
    security: [
      { name: "X-Agent-API-Key", type: "apiKey" },
 ...
 */
export const updateAgentConfiguration = <ThrowOnError extends boolean = false>(
  options: Options<UpdateAgentConfigurationData, ThrowOnError>,
) =>
 ...
 *
 */
export const sendAgentHeartbeat = <ThrowOnError extends boolean = false>(
  options: Options<SendAgentHeartbeatData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    SendAgentHeartbeatResponses,
    SendAgentHeartbeatErrors,
 ...
 *
 */
export const submitAgentResults = <ThrowOnError extends boolean = false>(
  options: Options<SubmitAgentResultsData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    SubmitAgentResultsResponses,
    SubmitAgentResultsErrors,
 ...
 *
 */
export const getResultReport = <ThrowOnError extends boolean = false>(
  options: Options<GetResultReportData, ThrowOnError>,
) =>
  (options.client ?? client).get<
    GetResultReportResponses,
    GetResultReportErrors,
...
export const listAlerts = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<ListAlertsResponses, unknown, ThrowOnError>({
 ...
 * Delete alert rule
 */
export const deleteAlert = <ThrowOnError extends boolean = false>(
  options: Options<DeleteAlertData, ThrowOnError>,
) =>
 ...
 *
 */
export const oauth2Authorize = <ThrowOnError extends boolean = false>(
  options: Options<Oauth2AuthorizeData, ThrowOnError>,
) =>
  (options.client ?? client).get<unknown, Oauth2AuthorizeErrors, ThrowOnError>({
 ...
 *
 */
export const oauth2Callback = <ThrowOnError extends boolean = false>(
...
export const oauth2Revoke = <ThrowOnError extends boolean = false>(
  options: Options<Oauth2RevokeData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    Oauth2RevokeResponses,
    Oauth2RevokeErrors,
 ...
 */
export const postCreateUser = <ThrowOnError extends boolean = false>(
  options: Options<PostCreateUserData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    PostCreateUserResponses,
    PostCreateUserErrors,
 ...
 * Create organization
 */
export const postCreateOrganization = <ThrowOnError extends boolean = false>(
  options: Options<PostCreateOrganizationData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    PostCreateOrganizationResponses,
    unknown,
 ...
 *
 */
export const getWebSocketToken = <ThrowOnError extends boolean = false>(
  options: Options<GetWebSocketTokenData, ThrowOnError>,
) =>
  (options.client ?? client).post<
    GetWebSocketTokenResponses,
    GetWebSocketTokenErrors,
 ...
 */
export const livenessCheck = <ThrowOnError extends boolean = false>(
 ...
 */
export const prometheusMetrics = <ThrowOnError extends boolean = false>(
  options?: Options<PrometheusMetricsData, ThrowOnError>,
) =>
  (options?.client ?? client).get<
    PrometheusMetricsResponses,
    unknown,
