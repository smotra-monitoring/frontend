...
export const AgentConfigSchema = {
  ...
  properties: {
    ...
    tags: {
      ...
      example: ["production", "web-server", "us-east"],
    },
    monitoring: {
...
export const StorageConfigSchema = {
  type: "object",
  required: ["cache_dir", "max_cached_results", "max_cache_age_secs"],
  properties: {
    cache_dir: {
      type: "string",
...
export const EndpointSchema = {
  ...
  required: ["id", "address", "enabled", "tags"],
  properties: {
    id: {
      $ref: "#/components/schemas/UUIDv7",
...
export const MonitoringResultSchema = {
  type: "object",
  required: ["id", "agent_id", "endpoint_id", "check_type", "timestamp"],
  properties: {
    id: {
      $ref: "#/components/schemas/UUIDv7",
...
export const PingResultSchema = {
  type: "object",
  required: ["resolved_ip", "successes", "failures", "success_latencies"],
  properties: {
    resolved_ip: {
      type: "string",
      format: "ipv4",
...
export const TcpConnectResultSchema = {
  type: "object",
  required: ["connected", "resolved_ip"],
  properties: {
    connected: {
      type: "boolean",
    },
...
export const UdpConnectResultSchema = {
  type: "object",
  required: ["probe_successful", "resolved_ip"],
  properties: {
    probe_successful: {
      type: "boolean",
    },
...
export const PluginResultSchema = {
  type: "object",
  required: ["plugin_name", "plugin_version", "success", "data"],
  properties: {
    plugin_name: {
      type: "string",
    },
...
export const ErrorDetailsSchema = {
  ...
  properties: {
    errors: {
      ...
      example: ["Timeout", "Host unreachable"],
    },
  },
} as const;
...
export const AgentNetworkInterfaceSchema = {
  type: "object",
  required: ["ip", "iface", "family", "recommended"],
  properties: {
    ip: {
      type: "string",
      description:
...
export const AgentRegistrationResponseSchema = {
  type: "object",
  required: ["status", "pollUrl", "claimUrl", "expiresAt"],
  properties: {
    status: {
...
export const ClaimStatusPendingSchema = {
  type: "object",
  required: ["status", "expiresAt", "pollIn"],
  properties: {
    status: {
...
export const ClaimStatusClaimedSchema = {
  type: "object",
  required: ["status", "apiKey", "configUrl"],
  properties: {
    status: {
...
export const ClaimAgentRequestSchema = {
  type: "object",
  required: ["agentId", "claimToken", "sectionId"],
  properties: {
    agentId: {
      $ref: "#/components/schemas/UUIDv7",
...
export const ClaimAgentResponseSchema = {
  type: "object",
  required: ["agentId", "status", "message"],
  properties: {
    agentId: {
      $ref: "#/components/schemas/UUIDv7",
...
export const ReportAcknowledgmentSchema = {
  type: "object",
  required: ["request_id", "status", "received_at"],
  properties: {
    request_id: {
      $ref: "#/components/schemas/UUIDv7",
    },
...
export const ResultsBatchAcknowledgmentSchema = {
  type: "object",
  required: ["submission_id", "accepted", "received_at"],
  properties: {
    submission_id: {
      $ref: "#/components/schemas/UUIDv7",
...
export const ResultReportSchema = {
  type: "object",
  required: ["time_range", "data", "pagination"],
  properties: {
    time_range: {
      type: "object",
      required: ["start", "end"],
...
export const AggregatedMetricSchema = {
  type: "object",
  required: ["timestamp", "agent_id", "target", "metric_type"],
  properties: {
    timestamp: {
      type: "string",
      format: "date-time",
...
export const AlertSchema = {
  type: "object",
  required: ["id", "rule_id", "status", "severity", "created_at"],
  properties: {
    id: {
      type: "string",
      format: "uuid",
...
export const AlertRuleSchema = {
  type: "object",
  required: ["name", "condition", "severity", "notifications"],
  properties: {
    id: {
      type: "string",
      format: "uuid",
